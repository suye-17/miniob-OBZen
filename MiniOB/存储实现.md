# MiniOB 存储实现[¶](https://oceanbase.github.io/miniob/design/miniob-buffer-pool/#miniob)

本节将从存储层面介绍 MiniOB 的实现。

## MiniOB 框架简介[¶](https://oceanbase.github.io/miniob/design/miniob-buffer-pool/#miniob_1)

首先回顾一下 MiniOB 的框架，在 MiniOB 概述章节已经简单的介绍过，本节重点介绍执行器（Executor）访问的存储引擎。

![Overview](https://oceanbase.github.io/miniob/design/images/miniob-overview.png)
...
## MiniOB 文件管理[¶](https://oceanbase.github.io/miniob/design/miniob-buffer-pool/#miniob_2)
...
![目录](https://oceanbase.github.io/miniob/design/images/miniob-buffer-pool-directory.png)
...
## MiniOB Buffer Pool 模块介绍[¶](https://oceanbase.github.io/miniob/design/miniob-buffer-pool/#miniob-buffer-pool)
...
![Buffer Pool](https://oceanbase.github.io/miniob/design/images/miniob-buffer-pool-implementation.png)
...
![Page](https://oceanbase.github.io/miniob/design/images/miniob-buffer-pool-page.png)
...
## MiniOB 记录管理[¶](https://oceanbase.github.io/miniob/design/miniob-buffer-pool/#miniob_3)
...
![Record Manager](https://oceanbase.github.io/miniob/design/images/miniob-buffer-pool-record.png)
